...
const AddReview = () => {
    ...
    const { displayName } = user?.currentUser;
        ...
        <div>
            ...
            <form onSubmit={handelPlaceOrder}>
                <div class="form-control w-full max-w-xs mt-2">
                    ...
                    <select class="select select-bordered" name='rating'>
                ...
                <div class="form-control w-full max-w-xs mt-2">
                    ...
                    <textarea class="textarea  select-bordered" name='description' placeholder="Say something.........."></textarea>
